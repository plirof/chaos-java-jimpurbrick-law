...
/* Decompiled by Mocha from FlyingMount.class */
/* Originally compiled from FlyingMount.java */
...
*/
class FlyingMount extends Flyer implements Data, Mount
{
		private boolean asked; 	// So we only ask about dismounting
														// once per turn.
    private Wizard rider;

    FlyingMount(String string, Square pos, boolean flag, Chaos game)
    {
